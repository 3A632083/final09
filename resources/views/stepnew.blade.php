...
@section('content')
    ...
    @include('common.errors')
        ...
        @foreach ($null1 as $null)
            ...
            @endif
        @endforeach
        <form action="/sectionnew/{id}" method="POST" class="form-horizontal">
        {{ csrf_field() }}
        {{ method_field('PATCH') }}
        ...
        @foreach ($null2 as $null)
            ...
            @endif
        @endforeach
        <form action="/sectionnew2/{id}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            {{ method_field('PATCH') }}
                <div class="form-group">
                <div class="col-sm-offset-3 col-sm-6">
        ...
        @foreach ($null3 as $null)
            ...
            @endif
        @endforeach
        <form action="/sectionnew3/{id}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            {{ method_field('PATCH') }}
                <div class="form-group">
                <div class="col-sm-offset-3 col-sm-6">
